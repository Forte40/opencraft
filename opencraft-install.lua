...
local files = {
  {
    name = "opencraft-install",
    url = "https://raw.github.com/Forte40/opencraft/"..branch.."/opencraft-install.lua"
  },
  {
    name = "opencraft",
    url = "https://raw.github.com/Forte40/opencraft/"..branch.."/opencraft.lua"
  },
  {
    name = "panel",
    folder = "apis",
